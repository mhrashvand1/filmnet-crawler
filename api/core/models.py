...
class Movie(BaseModel):
    ...
    release_year = models.SmallIntegerField(null=True, verbose_name=_("release year"))
    ...
    def get_filmnet_link(self):
        """Returns the link to filmnet.ir for the movie."""
...
class Genre(BaseModel):
    ...
    def get_filmnet_link(self):
        """Returns the link to filmnet.ir for the genre."""
        return f"https://filmnet.ir/categories/{self.short_id}/{self.slug}"
    
    def get_movie_count(self):
        """Returns the count of movies associated with this genre."""
